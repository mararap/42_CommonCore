...
Write a program that will take one and only one argument s. It will then read from stdin and write all the sonten read in stdout except that every occurence of s must be replaces by '*'.
